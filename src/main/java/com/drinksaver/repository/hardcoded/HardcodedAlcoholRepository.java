...
public class HardcodedAlcoholRepository implements AlcoholRepository {
    ...
    static {
        ALCOHOL_TYPES.put(1, new AlcoholType(1, "beer", List.of(
        ...
        ALCOHOL_TYPES.put(2, new AlcoholType(2, "cider", List.of(
                new AlcoholVolumeDescription("small bottle", 0.33f),
                new AlcoholVolumeDescription("large bottle", 0.5f),
                new AlcoholVolumeDescription("pint", 0.568f)
        )));
        ALCOHOL_TYPES.put(3, new AlcoholType(3, "spirit", List.of(
        ...
        ALCOHOL_TYPES.put(4, new AlcoholType(4, "champagne", List.of(
        ...
        ALCOHOL_TYPES.put(9, new AlcoholType(9, "chacha", List.of(
                new AlcoholVolumeDescription("shot", 0.05f),
                new AlcoholVolumeDescription("double", 0.1f)
        )));
        ALCOHOL_TYPES.put(10, new AlcoholType(10, "Piana Vyshnia", List.of(
                new AlcoholVolumeDescription("shot", 0.05f),
                new AlcoholVolumeDescription("double", 0.1f)
        )));
        ALCOHOL_TYPES.put(11, new AlcoholType(11, "limoncello", List.of(
        ...
        ALCOHOL_TYPES.put(12, new AlcoholType(12, "vodka", List.of(
                new AlcoholVolumeDescription("single shot", 0.025f),
                new AlcoholVolumeDescription("double shot", 0.05f),
                new AlcoholVolumeDescription("triple shot", 0.1f)
        )));
        ALCOHOL_TYPES.put(13, new AlcoholType(13, "Zubrowka", List.of(
                new AlcoholVolumeDescription("single shot", 0.025f),
                new AlcoholVolumeDescription("double shot", 0.05f),
                new AlcoholVolumeDescription("triple shot", 0.1f)
        )));
        ALCOHOL_TYPES.put(14, new AlcoholType(14, "prosecco", List.of(
                new AlcoholVolumeDescription("small glass", 0.125f),
                new AlcoholVolumeDescription("standard glass", 0.15f),
                new AlcoholVolumeDescription("bottle", 0.75f)
        )));
        ALCOHOL_TYPES.put(15, new AlcoholType(15, "palinka", List.of(
                new AlcoholVolumeDescription("single shot", 0.025f),
                new AlcoholVolumeDescription("double shot", 0.05f),
                new AlcoholVolumeDescription("triple shot", 0.1f)
        )));
        ALCOHOL_TYPES.put(16, new AlcoholType(16, "white wine", List.of(
                new AlcoholVolumeDescription("small glass", 0.125f),
                new AlcoholVolumeDescription("medium glass", 0.175f),
                new AlcoholVolumeDescription("large glass", 0.25f),
                new AlcoholVolumeDescription("bottle", 0.75f)
        )));
        ALCOHOL_TYPES.put(17, new AlcoholType(17, "aperitif", List.of(
        ...
        ALCOHOL_TYPES.put(18, new AlcoholType(18, "digestive", List.of(
                new AlcoholVolumeDescription("single", 0.025f),
                new AlcoholVolumeDescription("double", 0.05f)
        )));
        ALCOHOL_TYPES.put(19, new AlcoholType(19, "whiskey", List.of(
                new AlcoholVolumeDescription("single shot", 0.025f),
                new AlcoholVolumeDescription("standard shot", 0.035f),
                new AlcoholVolumeDescription("double shot", 0.05f)
        )));
        ALCOHOL_TYPES.put(20, new AlcoholType(20, "seltzer", List.of(
        ...
        ALCOHOL_TYPES.put(21, new AlcoholType(21, "ouzo", List.of(
                new AlcoholVolumeDescription("shot", 0.05f),
                new AlcoholVolumeDescription("double", 0.1f)
        )));
        ALCOHOL_TYPES.put(22, new AlcoholType(22, "Tubi", List.of(
                new AlcoholVolumeDescription("shot", 0.05f),
                new AlcoholVolumeDescription("double", 0.1f)
        )));
        ALCOHOL_TYPES.put(23, new AlcoholType(23, "froccs", List.of(
                new AlcoholVolumeDescription("small", 0.2f),
                new AlcoholVolumeDescription("medium", 0.3f),
                new AlcoholVolumeDescription("large", 0.5f)
        )));
        ALCOHOL_TYPES.put(24, new AlcoholType(24, "Ukrainian Honey", List.of(
                new AlcoholVolumeDescription("shot", 0.05f),
                new AlcoholVolumeDescription("double", 0.1f)
        )));
        ALCOHOL_TYPES.put(25, new AlcoholType(25, "soju", List.of(
                new AlcoholVolumeDescription("shot", 0.05f),
